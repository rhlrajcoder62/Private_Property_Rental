  ...
  return (
    <div id='Nav'>
      {visible? <div className="hamburger">
       <Link to={'/Login'} className='link'><div className="ham1">Login</div></Link>
        <Link to={'/Signup'} className='link'><div className="ham1">sign up</div></Link>
      ...
      <div className="nav2">
       ...
       <NavLink to={""} > <div className="svg11">
        ...
        <div className="svg11"><LuTentTree />
             <h3>Tent Houses</h3></div>
        <div className="svg11"><GiWoodCabin /><h3>Cabin</h3></div>
        <div className="svg11"><SiHomeassistantcommunitystore />
          <h3>Shops</h3></div>
